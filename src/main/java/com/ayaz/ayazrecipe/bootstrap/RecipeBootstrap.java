package com.ayaz.ayazrecipe.bootstrap;

import com.ayaz.ayazrecipe.domain.*;
import com.ayaz.ayazrecipe.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        recipeRepository.saveAll(getList());
    ...
    public List<Recipe> getList() {
        ...
        UnitOfMeasure cuphUom = cupUomOptional.get();
        ...
        guaRecipe.setDificulty(Difficulty.EASY);
        guaRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                "\n" +
        ...
        guaRecipe.addIngredient(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableUom));
        guaRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableUom));
        guaRecipe.addIngredient(new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), eachUom));
        guaRecipe.addIngredient(new Ingredient("Cilantro", new BigDecimal(2), tableUom, guaRecipe));
        ...
        tacosRecipe.addIngredient(new Ingredient("Salt", new BigDecimal(".5"), teaUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("packed baby arugula", new BigDecimal(3), cuphUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), cuphUom));
